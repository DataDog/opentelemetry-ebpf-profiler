...
func Loader(_ interpreter.EbpfHandler, info *interpreter.LoaderInfo) (interpreter.Data, error) {
	...
	if tlsDescElfAddr == 0 {
		...
		// 2. No relocation found because local/inital exec TLS model (executable) or local dynamic TLS model
...
func (d data) Attach(ebpf interpreter.EbpfHandler, pid libpf.PID,
	...
	procInfo := support.CustomLabelsProcInfo{Tls_offset: int32(int64(tlsOffset)), Dtv_offset: 0, Module_offset: 0}
